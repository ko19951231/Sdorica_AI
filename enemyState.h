...
public:
    ...
    int getSimplifiedHP(int interval){return this->HP>0?((int)(interval*(float)(this->HP-1)/(float)(this->MAX_HP))):-1;}
    int getSimplifiedShiled(int interval){return this->shield>0?((int)(interval*(float)(this->shield-1)/(float)(this->MAX_HP))):-1;}
    //set value
    void setEnemy(int k);
